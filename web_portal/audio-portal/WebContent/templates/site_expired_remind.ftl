...
<div style=" margin:0; padding:0; border:0; background:#FFF; width:700px; height:auto;font-family:Arial, Helvetica, sans-serif; "> 
  ...
  <table cellpadding="0" cellspacing="0" border="0" width="700" style=" background:#fff;">
    <tr height="60" >
      <td>
        <h2 style=" margin:0; padding:0; border:0; font-size:20px; color:#333; border-bottom:#ccc 1px solid; padding-bottom:5px; margin:0px 40px; font-family:"微软雅黑";">confcloud站点到期提醒</h2>
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      <td>
        <p style=" margin:0; padding:0; border:0; font-size:12px; color:#666666; line-height:22px; margin:0px 40px; font-family:Arial, Helvetica, sans-serif;">感谢您使用confcloud系统。您的站点还有<strong style=" color:#F00;">${exp_date}</strong>天到期，为不影响您的使用，请即时向您的销售代表或客服联系。</p>
      </td>
    </tr>
    <tr>
      <td>
...
<br />
温馨提示:<br />
站点到期后，所有会议数据，用户数据都会自动删除。给您带来的不便请谅解！</p>
      </td>
    </tr>
  </table>
