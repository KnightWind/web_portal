...
<div style=" margin:0; padding:0; border:0; background:#FFF; width:700px; height:auto;font-family:Arial, Helvetica, sans-serif; "> 
  ...
  <table cellpadding="0" cellspacing="0" border="0" width="700" style=" background:#fff;">
    <tr height="60" >
      <td>
        <h2 style=" margin:0; padding:0; border:0; font-size:20px; color:#333; border-bottom:#ccc 1px solid; padding-bottom:5px; margin:0px 40px; font-family:"微软雅黑";">Moderator Account Info Modified</h2>
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      <td>
        ...
        Please click <a href="http://${siteaddress}" style=" margin:0; padding:0; border:0;font-family:Arial, Helvetica, sans-serif;">Confcloud System Platform</a> to log in.
        </p>
