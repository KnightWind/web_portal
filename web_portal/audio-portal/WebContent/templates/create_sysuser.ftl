...
<div style=" margin:0; padding:0; border:0; background:#FFF; width:700px; height:auto;font-family:Arial, Helvetica, sans-serif; "> 
  <table cellpadding="0" cellspacing="0" border="0" width="700" style=" background:#fff;">
    <tr height="60">
      <td>
        <h2 style=" margin:0; padding:0; border:0; font-size:20px; color:#333; border-bottom:#ccc 1px solid; padding-bottom:5px; margin:0px 40px; font-family:"微软雅黑";">系统管理员帐号信息</h2>
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      <td>
        <p style=" margin:0; padding:0; border:0; font-size:12px; color:#666666; line-height:22px; margin:0px 40px; font-family:Arial, Helvetica, sans-serif;">感谢您使用confcloud系，
          您可以点击<a href="http://${siteaddress}/system" style=" margin:0; padding:0; border:0;font-family:Arial, Helvetica, sans-serif;">confcloud系统管理平台</a>登录系统。 </p>
      </td>
    </tr>
    <tr>
      <td>
