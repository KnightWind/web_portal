...
<html>
<head>
	<title>${LANG['bizconf.jsp.common.site_uneffe.res1']}</title>
...
<div class="Error_page ">
  <div class="Error_page_main">
    <dl>
      <dt>
      <!-- <img src="${baseUrlStatic}/images/ico404.png" width="244" height="160" /> -->
      </dt>
      <dd class="right_page">
          <p>${LANG['bizconf.jsp.common.site_uneffe.res2']}</p>
