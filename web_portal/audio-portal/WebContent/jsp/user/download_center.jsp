...
<div class="main_content">
  <div class="download_01">
    ...
    <div class="download_main">
      <dl>
        <dt><img src="/static/images/download_img01.jpg" width="158" height="122" /></dt>
        <dd>
    ...
    <div class="download_bottom"><img src="${baseUrlStatic}/images/download_bottom.gif" width="722" height="10" /></div>
  </div>
  <div class="download_01">
    <div class="download_head">
    ...
    <div class="download_main">
      <dl>
        <dt><img src="/static/images/updatte.png" width="158" height="122" /></dt>
        <dd>
  ...
  <div class="download_01">
    <div class="download_head">
      <h3>${LANG['bizconf.jsp.download_center.res9']}</h3>
    </div>
    <div class="download_main">
      <dl>
