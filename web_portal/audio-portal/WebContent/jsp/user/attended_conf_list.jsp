...
$(function() {
	...
	$(".attend_conf_search").watermark('主题、主持人');
});
</script>
...
<!--               <td class="k_a"><a href="#"><img src="/static/images/email02.png" width="12" height="17" align="absmiddle" style=" margin-right:5px;"  />删除</a></td> -->
            </tr>
          </table></td>
      </tr>
