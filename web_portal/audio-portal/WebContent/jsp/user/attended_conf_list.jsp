...
<title>${LANG['bizconf.jsp.attended_conf_list.res1']}</title>
...
function enterSumbit(){  
    ...
    if (event.keyCode == 13){       //${LANG['bizconf.jsp.attendConf.res4']}
    	resetPageNo();
    	queryConf.action = "/user/conf/listWithAttendedConf";
    	queryConf.submit();	
    }   
} 
...
$(function() {
	...
	$(".attend_conf_search").watermark('${LANG['bizconf.jsp.attended_conf_list.res5']}');
});
</script>
...
<form id="queryConf" name="queryConf" action="" method="post">
  ...
  <tr>
     ...
     <input name="titleOrHostName" id="titleOrHostName" class="meeting_ss attend_conf_search" type="text" value="${titleOrHostName }" onkeydown='enterSumbit()'/>
...
<!--               <td class="k_a"><a href="#"><img src="/static/images/email02.png" width="12" height="17" align="absmiddle" style=" margin-right:5px;"  />${LANG['bizconf.jsp.attended_conf_list.res12']}</a></td> -->
            </tr>
          </table></td>
      </tr>
