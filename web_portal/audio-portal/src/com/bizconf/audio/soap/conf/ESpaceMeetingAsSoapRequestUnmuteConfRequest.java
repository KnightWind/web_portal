/**
 * ESpaceMeetingAsSoapRequestUnmuteConfRequest.java
 *
...
public class ESpaceMeetingAsSoapRequestUnmuteConfRequest  implements java.io.Serializable {
    ...
    public ESpaceMeetingAsSoapRequestUnmuteConfRequest() {
    }
    ...
    /**
     * Gets the token value for this ESpaceMeetingAsSoapRequestUnmuteConfRequest.
     * 
     * @return token
     */
    ...
    /**
     * Sets the token value for this ESpaceMeetingAsSoapRequestUnmuteConfRequest.
     * 
     * @param token
     */
    ...
    /**
     * Gets the requester value for this ESpaceMeetingAsSoapRequestUnmuteConfRequest.
     * 
     * @return requester
     */
    ...
    /**
     * Sets the requester value for this ESpaceMeetingAsSoapRequestUnmuteConfRequest.
     * 
     * @param requester
     */
    ...
    /**
     * Gets the confId value for this ESpaceMeetingAsSoapRequestUnmuteConfRequest.
     * 
     * @return confId
     */
    ...
    /**
     * Sets the confId value for this ESpaceMeetingAsSoapRequestUnmuteConfRequest.
     * 
     * @param confId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ESpaceMeetingAsSoapRequestUnmuteConfRequest)) return false;
        ESpaceMeetingAsSoapRequestUnmuteConfRequest other = (ESpaceMeetingAsSoapRequestUnmuteConfRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ESpaceMeetingAsSoapRequestUnmuteConfRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("eSpaceMeeting", "eSpaceMeeting.as.soap.request.UnmuteConfRequest"));
