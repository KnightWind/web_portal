/**
 * ESpaceMeetingAsSoapRequestChangeConfMediaRequest.java
 *
...
public class ESpaceMeetingAsSoapRequestChangeConfMediaRequest  implements java.io.Serializable {
    ...
    public ESpaceMeetingAsSoapRequestChangeConfMediaRequest() {
    }
    ...
    /**
     * Gets the token value for this ESpaceMeetingAsSoapRequestChangeConfMediaRequest.
     * 
     * @return token
     */
    ...
    /**
     * Sets the token value for this ESpaceMeetingAsSoapRequestChangeConfMediaRequest.
     * 
     * @param token
     */
    ...
    /**
     * Gets the requester value for this ESpaceMeetingAsSoapRequestChangeConfMediaRequest.
     * 
     * @return requester
     */
    ...
    /**
     * Sets the requester value for this ESpaceMeetingAsSoapRequestChangeConfMediaRequest.
     * 
     * @param requester
     */
    ...
    /**
     * Gets the confId value for this ESpaceMeetingAsSoapRequestChangeConfMediaRequest.
     * 
     * @return confId
     */
    ...
    /**
     * Sets the confId value for this ESpaceMeetingAsSoapRequestChangeConfMediaRequest.
     * 
     * @param confId
     */
    ...
    /**
     * Gets the mediaBits value for this ESpaceMeetingAsSoapRequestChangeConfMediaRequest.
     * 
     * @return mediaBits
     */
    ...
    /**
     * Sets the mediaBits value for this ESpaceMeetingAsSoapRequestChangeConfMediaRequest.
     * 
     * @param mediaBits
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ESpaceMeetingAsSoapRequestChangeConfMediaRequest)) return false;
        ESpaceMeetingAsSoapRequestChangeConfMediaRequest other = (ESpaceMeetingAsSoapRequestChangeConfMediaRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ESpaceMeetingAsSoapRequestChangeConfMediaRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("eSpaceMeeting", "eSpaceMeeting.as.soap.request.ChangeConfMediaRequest"));
