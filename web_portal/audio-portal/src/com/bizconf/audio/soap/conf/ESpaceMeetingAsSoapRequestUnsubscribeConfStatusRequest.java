/**
 * ESpaceMeetingAsSoapRequestUnsubscribeConfStatusRequest.java
 *
...
public class ESpaceMeetingAsSoapRequestUnsubscribeConfStatusRequest  implements java.io.Serializable {
    ...
    public ESpaceMeetingAsSoapRequestUnsubscribeConfStatusRequest() {
    }
    ...
    /**
     * Gets the token value for this ESpaceMeetingAsSoapRequestUnsubscribeConfStatusRequest.
     * 
     * @return token
     */
    ...
    /**
     * Sets the token value for this ESpaceMeetingAsSoapRequestUnsubscribeConfStatusRequest.
     * 
     * @param token
     */
    ...
    /**
     * Gets the requester value for this ESpaceMeetingAsSoapRequestUnsubscribeConfStatusRequest.
     * 
     * @return requester
     */
    ...
    /**
     * Sets the requester value for this ESpaceMeetingAsSoapRequestUnsubscribeConfStatusRequest.
     * 
     * @param requester
     */
    ...
    /**
     * Gets the subscriberName value for this ESpaceMeetingAsSoapRequestUnsubscribeConfStatusRequest.
     * 
    ...
    /**
     * Sets the subscriberName value for this ESpaceMeetingAsSoapRequestUnsubscribeConfStatusRequest.
     * 
    ...
    /**
     * Gets the confId value for this ESpaceMeetingAsSoapRequestUnsubscribeConfStatusRequest.
     * 
     * @return confId
     */
    ...
    /**
     * Sets the confId value for this ESpaceMeetingAsSoapRequestUnsubscribeConfStatusRequest.
     * 
     * @param confId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ESpaceMeetingAsSoapRequestUnsubscribeConfStatusRequest)) return false;
        ESpaceMeetingAsSoapRequestUnsubscribeConfStatusRequest other = (ESpaceMeetingAsSoapRequestUnsubscribeConfStatusRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ESpaceMeetingAsSoapRequestUnsubscribeConfStatusRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("eSpaceMeeting", "eSpaceMeeting.as.soap.request.UnsubscribeConfStatusRequest"));
