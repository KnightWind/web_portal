/**
 * ESpaceMeetingAsSoapRequestCancelConfRequest.java
 *
...
public class ESpaceMeetingAsSoapRequestCancelConfRequest  implements java.io.Serializable {
    ...
    public ESpaceMeetingAsSoapRequestCancelConfRequest() {
    }
    ...
    /**
     * Gets the token value for this ESpaceMeetingAsSoapRequestCancelConfRequest.
     * 
     * @return token
     */
    ...
    /**
     * Sets the token value for this ESpaceMeetingAsSoapRequestCancelConfRequest.
     * 
     * @param token
     */
    ...
    /**
     * Gets the requester value for this ESpaceMeetingAsSoapRequestCancelConfRequest.
     * 
     * @return requester
     */
    ...
    /**
     * Sets the requester value for this ESpaceMeetingAsSoapRequestCancelConfRequest.
     * 
     * @param requester
     */
    ...
    /**
     * Gets the confId value for this ESpaceMeetingAsSoapRequestCancelConfRequest.
     * 
     * @return confId
     */
    ...
    /**
     * Sets the confId value for this ESpaceMeetingAsSoapRequestCancelConfRequest.
     * 
     * @param confId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ESpaceMeetingAsSoapRequestCancelConfRequest)) return false;
        ESpaceMeetingAsSoapRequestCancelConfRequest other = (ESpaceMeetingAsSoapRequestCancelConfRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ESpaceMeetingAsSoapRequestCancelConfRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("eSpaceMeeting", "eSpaceMeeting.as.soap.request.CancelConfRequest"));
