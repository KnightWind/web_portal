/**
 * ESpaceMeetingAsSoapRequestAddEnterpriseRequest.java
 *
...
public class ESpaceMeetingAsSoapRequestAddEnterpriseRequest  implements java.io.Serializable {
    ...
    public ESpaceMeetingAsSoapRequestAddEnterpriseRequest() {
    }
    ...
    /**
     * Gets the token value for this ESpaceMeetingAsSoapRequestAddEnterpriseRequest.
     * 
     * @return token
     */
    ...
    /**
     * Sets the token value for this ESpaceMeetingAsSoapRequestAddEnterpriseRequest.
     * 
     * @param token
     */
    ...
    /**
     * Gets the enterprise value for this ESpaceMeetingAsSoapRequestAddEnterpriseRequest.
     * 
     * @return enterprise
     */
    ...
    /**
     * Sets the enterprise value for this ESpaceMeetingAsSoapRequestAddEnterpriseRequest.
     * 
     * @param enterprise
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ESpaceMeetingAsSoapRequestAddEnterpriseRequest)) return false;
        ESpaceMeetingAsSoapRequestAddEnterpriseRequest other = (ESpaceMeetingAsSoapRequestAddEnterpriseRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ESpaceMeetingAsSoapRequestAddEnterpriseRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("eSpaceMeeting", "eSpaceMeeting.as.soap.request.AddEnterpriseRequest"));
