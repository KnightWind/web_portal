/**
 * ESpaceMeetingAsSoapRequestQueryIPSegListRequest.java
 *
...
public class ESpaceMeetingAsSoapRequestQueryIPSegListRequest  implements java.io.Serializable {
    ...
    public ESpaceMeetingAsSoapRequestQueryIPSegListRequest() {
    }
    ...
    /**
     * Gets the token value for this ESpaceMeetingAsSoapRequestQueryIPSegListRequest.
     * 
     * @return token
     */
    ...
    /**
     * Sets the token value for this ESpaceMeetingAsSoapRequestQueryIPSegListRequest.
     * 
     * @param token
     */
    ...
    /**
     * Gets the enterpriseId value for this ESpaceMeetingAsSoapRequestQueryIPSegListRequest.
     * 
     * @return enterpriseId
     */
    ...
    /**
     * Sets the enterpriseId value for this ESpaceMeetingAsSoapRequestQueryIPSegListRequest.
     * 
     * @param enterpriseId
     */
    ...
    /**
     * Gets the areaId value for this ESpaceMeetingAsSoapRequestQueryIPSegListRequest.
     * 
     * @return areaId
     */
    ...
    /**
     * Sets the areaId value for this ESpaceMeetingAsSoapRequestQueryIPSegListRequest.
     * 
     * @param areaId
     */
    ...
    /**
     * Gets the ipsegId value for this ESpaceMeetingAsSoapRequestQueryIPSegListRequest.
     * 
     * @return ipsegId
     */
    ...
    /**
     * Sets the ipsegId value for this ESpaceMeetingAsSoapRequestQueryIPSegListRequest.
     * 
     * @param ipsegId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ESpaceMeetingAsSoapRequestQueryIPSegListRequest)) return false;
        ESpaceMeetingAsSoapRequestQueryIPSegListRequest other = (ESpaceMeetingAsSoapRequestQueryIPSegListRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ESpaceMeetingAsSoapRequestQueryIPSegListRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("eSpaceMeeting", "eSpaceMeeting.as.soap.request.QueryIPSegListRequest"));
