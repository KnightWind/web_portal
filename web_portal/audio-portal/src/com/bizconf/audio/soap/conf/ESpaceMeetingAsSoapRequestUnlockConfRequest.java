/**
 * ESpaceMeetingAsSoapRequestUnlockConfRequest.java
 *
...
public class ESpaceMeetingAsSoapRequestUnlockConfRequest  implements java.io.Serializable {
    ...
    public ESpaceMeetingAsSoapRequestUnlockConfRequest() {
    }
    ...
    /**
     * Gets the token value for this ESpaceMeetingAsSoapRequestUnlockConfRequest.
     * 
     * @return token
     */
    ...
    /**
     * Sets the token value for this ESpaceMeetingAsSoapRequestUnlockConfRequest.
     * 
     * @param token
     */
    ...
    /**
     * Gets the requester value for this ESpaceMeetingAsSoapRequestUnlockConfRequest.
     * 
     * @return requester
     */
    ...
    /**
     * Sets the requester value for this ESpaceMeetingAsSoapRequestUnlockConfRequest.
     * 
     * @param requester
     */
    ...
    /**
     * Gets the confId value for this ESpaceMeetingAsSoapRequestUnlockConfRequest.
     * 
     * @return confId
     */
    ...
    /**
     * Sets the confId value for this ESpaceMeetingAsSoapRequestUnlockConfRequest.
     * 
     * @param confId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ESpaceMeetingAsSoapRequestUnlockConfRequest)) return false;
        ESpaceMeetingAsSoapRequestUnlockConfRequest other = (ESpaceMeetingAsSoapRequestUnlockConfRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ESpaceMeetingAsSoapRequestUnlockConfRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("eSpaceMeeting", "eSpaceMeeting.as.soap.request.UnlockConfRequest"));
