/**
 * ESpaceMeetingAsSoapRequestUpdateEnterpriseRequest.java
 *
...
public class ESpaceMeetingAsSoapRequestUpdateEnterpriseRequest  implements java.io.Serializable {
    ...
    public ESpaceMeetingAsSoapRequestUpdateEnterpriseRequest() {
    }
    ...
    /**
     * Gets the token value for this ESpaceMeetingAsSoapRequestUpdateEnterpriseRequest.
     * 
     * @return token
     */
    ...
    /**
     * Sets the token value for this ESpaceMeetingAsSoapRequestUpdateEnterpriseRequest.
     * 
     * @param token
     */
    ...
    /**
     * Gets the enterprise value for this ESpaceMeetingAsSoapRequestUpdateEnterpriseRequest.
     * 
     * @return enterprise
     */
    ...
    /**
     * Sets the enterprise value for this ESpaceMeetingAsSoapRequestUpdateEnterpriseRequest.
     * 
     * @param enterprise
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ESpaceMeetingAsSoapRequestUpdateEnterpriseRequest)) return false;
        ESpaceMeetingAsSoapRequestUpdateEnterpriseRequest other = (ESpaceMeetingAsSoapRequestUpdateEnterpriseRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ESpaceMeetingAsSoapRequestUpdateEnterpriseRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("eSpaceMeeting", "eSpaceMeeting.as.soap.request.UpdateEnterpriseRequest"));
