/**
 * ESpaceMeetingAsSoapRequestLockConfRequest.java
 *
...
public class ESpaceMeetingAsSoapRequestLockConfRequest  implements java.io.Serializable {
    ...
    public ESpaceMeetingAsSoapRequestLockConfRequest() {
    }
    ...
    /**
     * Gets the token value for this ESpaceMeetingAsSoapRequestLockConfRequest.
     * 
     * @return token
     */
    ...
    /**
     * Sets the token value for this ESpaceMeetingAsSoapRequestLockConfRequest.
     * 
     * @param token
     */
    ...
    /**
     * Gets the requester value for this ESpaceMeetingAsSoapRequestLockConfRequest.
     * 
     * @return requester
     */
    ...
    /**
     * Sets the requester value for this ESpaceMeetingAsSoapRequestLockConfRequest.
     * 
     * @param requester
     */
    ...
    /**
     * Gets the confId value for this ESpaceMeetingAsSoapRequestLockConfRequest.
     * 
     * @return confId
     */
    ...
    /**
     * Sets the confId value for this ESpaceMeetingAsSoapRequestLockConfRequest.
     * 
     * @param confId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ESpaceMeetingAsSoapRequestLockConfRequest)) return false;
        ESpaceMeetingAsSoapRequestLockConfRequest other = (ESpaceMeetingAsSoapRequestLockConfRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ESpaceMeetingAsSoapRequestLockConfRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("eSpaceMeeting", "eSpaceMeeting.as.soap.request.LockConfRequest"));
