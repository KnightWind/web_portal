/**
 * ESpaceMeetingAsSoapRequestQueryCycleConfInfoRequest.java
 *
...
public class ESpaceMeetingAsSoapRequestQueryCycleConfInfoRequest  implements java.io.Serializable {
    ...
    public ESpaceMeetingAsSoapRequestQueryCycleConfInfoRequest() {
    }
    ...
    /**
     * Gets the token value for this ESpaceMeetingAsSoapRequestQueryCycleConfInfoRequest.
     * 
     * @return token
     */
    ...
    /**
     * Sets the token value for this ESpaceMeetingAsSoapRequestQueryCycleConfInfoRequest.
     * 
     * @param token
     */
    ...
    /**
     * Gets the requester value for this ESpaceMeetingAsSoapRequestQueryCycleConfInfoRequest.
     * 
     * @return requester
     */
    ...
    /**
     * Sets the requester value for this ESpaceMeetingAsSoapRequestQueryCycleConfInfoRequest.
     * 
     * @param requester
     */
    ...
    /**
     * Gets the cycleId value for this ESpaceMeetingAsSoapRequestQueryCycleConfInfoRequest.
     * 
     * @return cycleId
     */
    ...
    /**
     * Sets the cycleId value for this ESpaceMeetingAsSoapRequestQueryCycleConfInfoRequest.
     * 
     * @param cycleId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ESpaceMeetingAsSoapRequestQueryCycleConfInfoRequest)) return false;
        ESpaceMeetingAsSoapRequestQueryCycleConfInfoRequest other = (ESpaceMeetingAsSoapRequestQueryCycleConfInfoRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ESpaceMeetingAsSoapRequestQueryCycleConfInfoRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("eSpaceMeeting", "eSpaceMeeting.as.soap.request.QueryCycleConfInfoRequest"));
