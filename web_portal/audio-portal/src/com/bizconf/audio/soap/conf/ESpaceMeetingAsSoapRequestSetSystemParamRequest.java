/**
 * ESpaceMeetingAsSoapRequestSetSystemParamRequest.java
 *
...
public class ESpaceMeetingAsSoapRequestSetSystemParamRequest  implements java.io.Serializable {
    ...
    public ESpaceMeetingAsSoapRequestSetSystemParamRequest() {
    }
    ...
    /**
     * Gets the token value for this ESpaceMeetingAsSoapRequestSetSystemParamRequest.
     * 
     * @return token
     */
    ...
    /**
     * Sets the token value for this ESpaceMeetingAsSoapRequestSetSystemParamRequest.
     * 
     * @param token
     */
    ...
    /**
     * Gets the kvList value for this ESpaceMeetingAsSoapRequestSetSystemParamRequest.
     * 
     * @return kvList
     */
    ...
    /**
     * Sets the kvList value for this ESpaceMeetingAsSoapRequestSetSystemParamRequest.
     * 
     * @param kvList
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ESpaceMeetingAsSoapRequestSetSystemParamRequest)) return false;
        ESpaceMeetingAsSoapRequestSetSystemParamRequest other = (ESpaceMeetingAsSoapRequestSetSystemParamRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ESpaceMeetingAsSoapRequestSetSystemParamRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("eSpaceMeeting", "eSpaceMeeting.as.soap.request.SetSystemParamRequest"));
