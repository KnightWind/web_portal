/**
 * ESpaceMeetingAsSoapRequestStartRecordConfRequest.java
 *
...
public class ESpaceMeetingAsSoapRequestStartRecordConfRequest  implements java.io.Serializable {
    ...
    public ESpaceMeetingAsSoapRequestStartRecordConfRequest() {
    }
    ...
    /**
     * Gets the token value for this ESpaceMeetingAsSoapRequestStartRecordConfRequest.
     * 
     * @return token
     */
    ...
    /**
     * Sets the token value for this ESpaceMeetingAsSoapRequestStartRecordConfRequest.
     * 
     * @param token
     */
    ...
    /**
     * Gets the requester value for this ESpaceMeetingAsSoapRequestStartRecordConfRequest.
     * 
     * @return requester
     */
    ...
    /**
     * Sets the requester value for this ESpaceMeetingAsSoapRequestStartRecordConfRequest.
     * 
     * @param requester
     */
    ...
    /**
     * Gets the confId value for this ESpaceMeetingAsSoapRequestStartRecordConfRequest.
     * 
     * @return confId
     */
    ...
    /**
     * Sets the confId value for this ESpaceMeetingAsSoapRequestStartRecordConfRequest.
     * 
     * @param confId
     */
    ...
    /**
     * Gets the mediaBits value for this ESpaceMeetingAsSoapRequestStartRecordConfRequest.
     * 
     * @return mediaBits
     */
    ...
    /**
     * Sets the mediaBits value for this ESpaceMeetingAsSoapRequestStartRecordConfRequest.
     * 
     * @param mediaBits
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ESpaceMeetingAsSoapRequestStartRecordConfRequest)) return false;
        ESpaceMeetingAsSoapRequestStartRecordConfRequest other = (ESpaceMeetingAsSoapRequestStartRecordConfRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ESpaceMeetingAsSoapRequestStartRecordConfRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("eSpaceMeeting", "eSpaceMeeting.as.soap.request.StartRecordConfRequest"));
