...
public class EventLogConstantsTag extends TagSupport {

	private static final long serialVersionUID = 2759673510971259743L;

	private final Logger logger = Logger.getLogger(EventLogConstants.class);
	public String clzName = EventLogConstants.class.getName();
