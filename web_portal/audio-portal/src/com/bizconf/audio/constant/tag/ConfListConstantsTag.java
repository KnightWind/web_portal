...
public class ConfListConstantsTag extends TagSupport {

	private static final long serialVersionUID = 2759673510971259743L;

	private final Logger logger = Logger.getLogger(ConfListConstantsTag.class);
	public String clzName = ConfConstant.class.getName();
