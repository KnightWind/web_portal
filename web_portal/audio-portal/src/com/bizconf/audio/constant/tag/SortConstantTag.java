...
public class SortConstantTag extends TagSupport {

	/**
	 * 
	 */
	private static final long serialVersionUID = -245548884792073739L;

	private final Logger logger = Logger.getLogger(SortConstantTag.class);
	public String clzName = SortConstant.class.getName();
