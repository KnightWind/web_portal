...
public class LoginConstants {
	...
	public static final String SYSTEM_USER_SESSION_ID_KEY = "!@#S!@#!@#!@#%$$%$%dfagFDF";
	
	public static final String SITE_ADMIN_SESSION_ID_KEY = "!@#S!@#!@#!@#%$$%$%dfagFDF";
	
	public static final String USER_SESSION_ID_KEY = "!@#S!@#!@#!@#%$$%$%dfagFDF";
